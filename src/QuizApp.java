        ...
        if(passWord.equals(password)&&userName.equals(username)) {
            ...
            do {
                ...
                if (subjectNo.equals(s1)) {
                    ...
                    String[][] options = {
                            {"(A) Data Batch Management System", "(B) Database Management Solution", "(C) Database Management System", "(D) Data Backup Management System"},
                            {"(A) Generating raw data", "(B) Creating complex databases", "(C) Managing database structures and data access", "(D) Generating reports only"},
                            {"(A) Alignment, Consistency, Isolation, Durability", "(B) Atomicity, Consistency, Isolation, Durability", "(C) Atomicity, Concurrency, Isolation, Data-integrity", "(D) Alignment, Concurrency, Isolation, Durability"},
                            {"(A) Data Redundancy refers to the duplication of data in a database.", "(B) Data Redundancy refers to the efficient storage of data in a database.", "(C) Data Redundancy refers to the speed of data retrieval in a database.", "(D) Data Redundancy refers to the security features of a database."},
                            {"(A) Hierarchical model", "(B) Network model", "(C) Relational model", "(D) Object-oriented model"},
                            {"(A) A key that unlocks the database for data entry.", "(B) The main key used for database encryption.", "(C) The highest security level in a database system.", "(D) A unique identifier for each record in a table."},
                            {"(A) Entity Relationship", "(B) Entity Runtime", "(C) Execute Read", "(D) Extra Record"},
                            {"(A) Entity", "(B) Attribute", "(C) Relationship", "(D) Connector"},
                            {"(A) Oracle Database", "(B) Microsoft SQL Server", "(C) MySQL", "(D) IBM Db2"},
                            {"(A) INNER JOIN", "(B) OUTER JOIN", "(C) FULL JOIN", "(D) SIDE JOIN"}
                    };
                    ...
                    String[][] options = {
                            {"A) Napier's Bones", "B) Pascaline", "C) Abacus", "D) Stepped Reckoner"},
                            {"A) Reliability issues", "B) Continuous burning out of vacuum tubes", "C) Moving pieces as a major drawback", "D) Unreliability in executing calculations"},
                            {"A) Microcomputers", "B) Minicomputers", "C) Mainframes", "D) Supercomputers"},
                            {"A) Greater storage capacity", "B) Increased speed and processing capability", "C) Advanced input/output devices", "D) Lower cost and affordability"},
                            {"A) System Software", "B) Programming Software", "C) Application Software", "D) Utility Software"},
                            {"A) Permanent data storage", "B) Pre-loaded with static data", "C) Read from and written to whenever instructed by CPU", "D) Stores frequently used data items to reduce main memory access"},
                            {"A) Arithmetic and Logic Unit", "B) Processor Register", "C) Control Unit", "D) Memory Unit"},
                            {"A) Storing frequently used data items", "B) Performing arithmetic and logic operations on instruction words", "C) Offering rapid access for reading and writing data", "D) Directing operations of all computer components"},
                            {"A) RAM can only read data, while ROM can write data.", "B) RAM is volatile, while ROM is non-volatile.", "C) RAM is slower than ROM in accessing data.", "D) ROM is used for temporary storage, while RAM is for permanent storage."},
                            {"A) Wireless mouse, Bluetooth mouse, Optical mouse", "B) Headset, LCD Monitors, Laser Printer", "C) Hard Drives, Optical Drives, Floppy Drives", "D) Random Access Memory (RAM), Read Only Memory (ROM), Cache Memory"}
                    };
                    ...
                    System.out.println("Please Enter correct subject number");
                }
